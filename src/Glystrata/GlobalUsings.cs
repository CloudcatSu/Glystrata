...
global using Group = Glystrata.Core.Groups.Group;
global using GroupItem = Glystrata.Core.Groups.GroupItem;
global using Glystrata.Core.Documents;
global using Glystrata.Core.Groups;
global using Glystrata.Core.Layout;
global using Glystrata.Core.Markdown;
global using Glystrata.Core.Persistence;
global using Glystrata.Core.Snapshots;
global using Glystrata.Dialogs;
global using Glystrata.Services;
